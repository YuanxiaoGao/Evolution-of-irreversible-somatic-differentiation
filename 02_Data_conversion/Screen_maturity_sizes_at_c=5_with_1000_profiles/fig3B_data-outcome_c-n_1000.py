...
with open('../../03_Data/Parameters_of_1000_lines/v37_1000_v1.pickle', 'rb') as f:
...
for n in range(5,division_times):                        # how many figures or cell divisions
	for c_cluster in range(5,6):                         # fix cost into 5
		st_num=0
...
np.save('../../03_Data/Screen_maturity_sizes_at_c=5_with_1000_profiles/data_n_c5_%s.npy'%num_lines,result6)
