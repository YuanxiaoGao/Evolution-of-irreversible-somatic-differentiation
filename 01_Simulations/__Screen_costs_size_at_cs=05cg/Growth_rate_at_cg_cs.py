...
'''In the third version, we changed the growth time function T to a step function.
	we set m=300,grid_num=30,size=5
	and calculate all optimal dp for varying n'''
