...
for n in range(1,division_times):                        # how many figures or cell divisions
	for c_cluster in range(0,grid_num):                  # 1,---,30
		...
		for line_id in range(0,num_lines):            # 0,---,29
			...
			DataLocation = '../../03_Data/__Screen_costs_size_at_cs=05cg/%d_%d_%d.txt'%(n,c_cluster,line_id)
...
PlotSizeCostsHeatmap(Data_ISD, ModifiedCMap, 'heatmap_ncg_cs=05cg_v3'+PalName+'.pdf', Write2File)